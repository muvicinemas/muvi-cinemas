...
export interface OutGoingRequestsLogOptionsFactory {
  createOutGoingRequestsLogModuleOptions():
    | Promise<OutGoingRequestsLogOptions>
    | OutGoingRequestsLogOptions;
}

export interface OutGoingRequestsLogAsyncOptions
  extends Pick<ModuleMetadata, 'imports'> {
  useExisting?: Type<OutGoingRequestsLogOptionsFactory>;
  useClass?: Type<OutGoingRequestsLogOptionsFactory>;
  useFactory?: (
    ...args: any[]
  ) => Promise<OutGoingRequestsLogOptions> | OutGoingRequestsLogOptions;
  inject?: any[];
