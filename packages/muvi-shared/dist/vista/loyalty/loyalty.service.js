...
let LoyaltyService = class LoyaltyService {
    ...
    async validateMember(data, platform) {
        const connectAPIObject = this.getConnectObject(platform);
        const response = await this.httpService.axiosRef.post(this.options.baseUrl + vista_apis_urls_1.VistaApisUrls.VALIDATE_MEMBER, Object.assign(Object.assign({}, data), { ReturnMember: true }), {
            headers: {
