...
export declare enum ConnectApiTokenKey {
    WEBSITE = "website",
    ANDROID = "android",
    IOS = "ios",
    HUAWEI = "huawei",
...
export interface IVistaModuleOptionsFactory {
    createThrottlerOptions(): Promise<IVistaModuleOptions> | IVistaModuleOptions;
}
export type ConnectAPITokenKeyType = ConnectApiTokenKey | string;
export interface IVistaModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
    useFactory: (...args: any[]) => Promise<IVistaModuleOptions> | IVistaModuleOptions;
    inject?: any[];
}
